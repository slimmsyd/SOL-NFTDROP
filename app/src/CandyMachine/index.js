...
const REACT_APP_SOLANA_RPC_HOST = " https://api.devnet.solana.com"
...
const getCandyMachineState = async () => {
  ...
  const candyMachine = await program.account.candyMachine.fetch(
   "DWuiDUsHVCjnwkEVQp6AkyMAmxHgVmg4QKcpotaNwXKa"
  );
  ...
  console.log({
    ...
    setCandyMachine({
      id:  "DWuiDUsHVCjnwkEVQp6AkyMAmxHgVmg4QKcpotaNwXKa",
      program,
      state: {
        itemsAvailable,
        itemsRedeemed,
